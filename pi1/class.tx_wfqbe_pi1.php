...
*/
	...
	function initFF()	{
		...
		/*if (strpos($this->conf['template'], \TYPO3\CMS\Core\Utility\GeneralUtility::getIndpEnv('TYPO3_DOCUMENT_ROOT'))!==false)
			$this->conf['template'] = str_replace(\TYPO3\CMS\Core\Utility\GeneralUtility::getIndpEnv('TYPO3_DOCUMENT_ROOT').'/', '', $this->conf['template']);*/
	}
